...
namespace environmentMonitoring.Database.Migrations
{
    ...
    [Migration("20250417151910_permissionsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PermissionsRole", b =>
                {
                    b.Property<int>("Permissionspermission_Id")
                        .HasColumnType("int");

                    b.Property<int>("role_Id")
                        .HasColumnType("int");

                    b.HasKey("Permissionspermission_Id", "role_Id");
            ...
            modelBuilder.Entity("environmentMonitoring.Database.Models.Permissions", b =>
                {
            ...
            modelBuilder.Entity("PermissionsRole", b =>
                {
                    b.HasOne("environmentMonitoring.Database.Models.Permissions", null)
                        .WithMany()
                        .HasForeignKey("Permissionspermission_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("environmentMonitoring.Database.Models.Role", null)
                        .WithMany()
